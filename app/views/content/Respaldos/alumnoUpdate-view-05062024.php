<?php
	...
	$datosconyugerep=$insAlumno->seleccionarDatos("Unico","alumno_representanteconyuge","conyuge_repid",$datosrepresentante['repre_id']);
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="alumno_identificacion" name="alumno_identificacion" value="<?php echo $datos['alumno_identificacion']; ?>">
													</div>
												</div>											
												<div class="col-md-4">                        
													<div class="form-group">
														<label for="alumno_apellido1">Apellido paterno</label>
														<input type="text" class="form-control" id="alumno_apellido1" name="alumno_apellido1" value="<?php echo $datos['alumno_apellidopaterno']; ?>">
													</div>
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-4">                        
													<div class="form-group">
														...
														<input type="text" class="form-control" id="alumno_nombre1" name="alumno_nombre1" value="<?php echo $datos['alumno_primernombre']; ?>">
													</div>
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-4">									
													<div class="form-group">
														...
														<div class="input-group">
															...
															<input type="date" class="form-control" name="alumno_fechanacimiento" value="<?php echo $datos['alumno_fechanacimiento']; ?>">
														</div>
													<!-- /.input group -->
													</div>												
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														<div class="form-check">
															<input class="col-sm-1 form-check-input" type="radio" id="alumno_generoM" name="alumno_genero" value="M" <?php echo $alumno_generoM; ?>>
									...
									<div class="col-md-6">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<!-- radio -->
												<div class="form-check">
													<input class="col-sm-1 form-check-input" type="radio" id="alumno_hermanosSi" name="alumno_hermanos" value="S" <?php echo $alumno_hermanosSi; ?>>
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="date" class="form-control" name="alumno_fechaingreso" value="<?php echo $datos['alumno_fechaingreso']; ?>">
												</div>
											<!-- /.input group -->
											</div>								
										</div>
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="repre_identificacion" name="repre_identificacion" value="<?php echo $datosrepresentante['repre_identificacion']; ?>">
											</div>
										</div>                   
										<div class="col-md-4">                        
											<div class="form-group">
												<label for="repre_apellidopaterno">Apellido paterno</label>
												<input type="text" class="form-control" id="repre_apellidopaterno" name="repre_apellidopaterno" value="<?php echo $datosrepresentante['repre_apellidopaterno']; ?>">
											</div>
										</div>
										<div class="col-md-4">
											<label for="repre_apellidomaterno">Apellido materno</label>
											<input type="text" class="form-control" id="repre_apellidomaterno" name="repre_apellidomaterno" value="<?php echo $datosrepresentante['repre_apellidomaterno']; ?>" >
										</div>
										<div class="col-sm-3">
											<div class="form-group">
												...
												<select id="repre_tipoidentificacion" class="form-control custom-select2" name="repre_tipoidentificacion">
													<?php echo $insAlumno->listarOptionTipoIdentificacion($datosrepresentante['repre_tipoidentificacion']); ?>
												</select>
											</div>          
										</div>
										<div class="col-md-3">                        
											<div class="form-group">
												...
												<input type="text" class="form-control" id="repre_primernombre" name="repre_primernombre" value="<?php echo $datosrepresentante['repre_primernombre']; ?>" >
											</div>
										</div>
										<div class="col-md-3">
											<label for="repre_segundonombre">Segundo nombre</label>
											<input type="text" class="form-control" id="repre_segundonombre" name="repre_segundonombre" value="<?php echo $datosrepresentante['repre_segundonombre']; ?>" >
										</div>
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-control select2" style="width: 100%;" id="repre_parentesco" name="repre_parentesco">
													<?php echo $insAlumno->listarOptionParentesco($datosrepresentante['repre_parentesco']); ?>
												</select>
											</div> 
										</div>
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="repre_direccion" name="repre_direccion" value="<?php echo $datosrepresentante['repre_direccion']; ?>" >
											</div>
										</div>              
										<div class="col-md-3">
											<div class="form-group">
												<label for="repre_correo">Correo</label>
												<input type="text" class="form-control" id="repre_correo" name="repre_correo" value="<?php echo $datosrepresentante['repre_correo']; ?>" >
											</div> 
										</div>
										<div class="col-md-2">
											<div class="form-group">
												<label for="repre_celular">Celular</label>
												<input type="text" class="form-control" id="repre_celular" name="repre_celular" value="<?php echo $datosrepresentante['repre_celular']; ?>" >
											</div> 
										</div>
										<div class="col-md-3">
											<div class="form-group">
