<?php
	...
	if($datos->rowCount()==1){
		...
		$recibo_hora = $pairs[0].":".$pairs[2].":".$pairs[4];
						...
						<div class="col-10">
							...
							<div class="invoice p-3 mb-3">							
								...
								<div class="row invoice-info">
									<div class="col-sm-6 invoice-col">										
										<address class="text-center">												
											<img src="<?php echo APP_URL.'app/views/dist/img/Logos/login.jpg' ?>" class="profile-user-img img-fluid mb-2" alt="white sample"/>										
										...
										<table class="table table-striped table-sm">											
											<tbody>
												<tr>													
													...
													<th class="text-right"><?php echo $datos['transaccion_recibo']; ?></th>																							
												</tr>	
												<tr>													
													<th>Recibo de: </th>	
								...
								<div class="row no-print">
									<div class="col-12">
										<button type="button" class="btn btn-success float-right" style="margin-right: 5px;"><i class="far fa-credit-card"></i> Enviar recibo
										</button>
										<button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
											<i class="fas fa-download"></i> Descargar recibo
										</button>

										<a href="<?php echo APP_URL.'pagospendienteReciboPDF/'.$pagoid.'/'; ?> " class="btn btn-dark float-right" style="margin-right: 5px;" target="_blank"> <i class="fas fa-print"></i>Imprimir recibo</a>
