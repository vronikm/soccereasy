<?php
	...
	if($datos->rowCount()==1){
		...
		if($datos['pendiente']==1){
			$pendiente = mb_convert_encoding("Pendiente", 'ISO-8859-1', 'UTF-8');
			$clase = '<a class="float-right text-danger">';
		}else{
			$pendiente = mb_convert_encoding("Al día", 'ISO-8859-1', 'UTF-8');
								...
								<div class="card-body box-profile">
									...
									<ul class="list-group list-group-unbordered mb-3">
										...
										<li class="list-group-item">
											<b>Estado pagos</b> 												
											<?php												
												echo $clase.mb_convert_encoding($pendiente, 'ISO-8859-1', 'UTF-8').'</a>'; 												
											?>
										</li>
										<li class="list-group-item">
