							...
							<div class="invoice p-3 mb-3">							
								...
								<div class="row no-print">
									<div class="col-12">
										...
										<a href="<?php echo APP_URL.'pagosReciboEnvio/'.$pagoid.'/'; ?> " class="btn btn-success btn-sm float-right" style="margin-right: 120px;" target="_blank"> <i class="fas fa-credit-card"></i> Enviar recibo</a-->
										
										<form class="FormularioAjax" action="'.APP_URL.'app/ajax/pagosAjax.php" method="POST" autocomplete="off" >
											<input type="hidden" name="modulo_pagos" value="envioCorreo">
											<input type="hidden" name="pago_id" value="<?php echo $pagoid; ?>">						
											<button type="submit" class="btn btn-success float-right btn-sm" style="margin-right: 60px;"><i class="far fa-credit-card"></i> Enviar recibo</button>
										</form>	


										<a href="<?php echo APP_URL.'pagosReciboPDF/'.$pagoid.'/'; ?> " class="btn btn-dark float-right btn-sm" style="margin-right: 5px;" target="_blank"> <i class="fas fa-print"></i>Imprimir recibo</a>
