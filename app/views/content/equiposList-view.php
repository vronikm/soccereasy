			...
			<!-- Small boxes (Stat box) -->
				<div class="card card-default">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">	
								<form class="FormularioAjax" id="quickForm" action="<?php echo APP_URL; ?>app/ajax/equiposAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
									<input type="hidden" name="modulo_equipos" value="<?php echo $modulo_equipos; ?>">
										...
										<div class="col-sm-10">
											<div class="row" style="font-size: 13px;">
												...
												<div class="col-md-12">						
													...
													<a href="<?php echo APP_URL; ?>equiposList/" class="btn btn-info btn-xs">Cancelar</a>
