      ...
      <div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Actualizar profesor</h1>
					</div><!-- /.col -->
					<div class="col-sm-6">
		...
		<section class="content">
			<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/profesorAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
				...
				<input type="hidden" name="profesor_id" value="<?php echo $datosprofesor['profesor_id']; ?>">
			<div class="container-fluid">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="profesor_identificacion" name="profesor_identificacion" value="<?php echo $profesor_identificacion; ?>" >
										</div>
									</div>									
									<div class="col-md-3">
										<div class="form-group">
											<label for="profesor_nombre">Nombre y Apellido</label>
											<input type="text" class="form-control" id="profesor_nombre" name="profesor_nombre" value="<?php echo $profesor_nombre; ?>" >
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="profesor_correo">Correo</label>
											<input type="email" class="form-control" id="profesor_correo" name="profesor_correo" value="<?php echo $profesor_correo; ?>" >	
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label for="profesor_celular">Celular</label>
											<input type="text" class="form-control" id="profesor_celular" name="profesor_celular" value="<?php echo $profesor_celular; ?>" >
										</div> 
									</div>								
									<div class="col-sm-3">
										<div class="form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="profesor_fechaingreso" id="profesor_fechaingreso" value="<?php echo $profesor_fechaingreso; ?>" >
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="profesor_direccion" name="profesor_direccion" value="<?php echo $profesor_direccion; ?>" >
										</div>	
									</div>									
									<div class="col-md-2">
										<div class="form-group">
